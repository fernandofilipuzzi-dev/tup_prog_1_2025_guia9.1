        ...
        static void Main(string[] args)
        {
            ...
            if (contador > 0)
            {
                ...
                for (int n = 0; n < contador; n++)
                {
                    ...
                    if (n == 0 || notas[n] > notas[indiceNotaMayor])
                    {
                        indiceNotaMayor = n;
                    }
                    #endregion
                    ...
                    if (n == 0 || notas[n] < notas[indiceNotaMenor])
                    {
                        indiceNotaMenor = n;
                    }
                    #endregion
            ...
            if (contador > 0)
            {
                ...
                Console.WriteLine($"El alumno: {nombres[indiceNotaMayor]}({libretas[indiceNotaMayor]}) es el primero con la mayor nota: {notas[indiceNotaMayor]}");
                Console.WriteLine($"El alumno: {nombres[indiceNotaMenor]}({libretas[indiceNotaMenor]}) es el primero con la menor nota: {notas[indiceNotaMenor]}");
            }
            else
            {
